...
class UPRDBoolBPLibrary : public UBlueprintFunctionLibrary
{
	...
	//获取伪随机分布概率增量
	UFUNCTION(Blueprintpure, meta = (ReturnDisplayName = "ProbabilityIncrement",DisplayName = "Get Pseudo Random Probability Increment", ToolTip = "Returns the constant probability increment corresponding to Probability.", Category = "Math|Random"))
